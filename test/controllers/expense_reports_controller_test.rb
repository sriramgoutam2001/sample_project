...
class ExpenseReportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create expense_report" do
    assert_difference("ExpenseReport.count") do
      post expense_reports_url, params: { expense_report: { description: @expense_report.description, name: @expense_report.name, total_amount: @expense_report.total_amount } }
    end
  ...
  test "should update expense_report" do
    patch expense_report_url(@expense_report), params: { expense_report: { description: @expense_report.description, name: @expense_report.name, total_amount: @expense_report.total_amount } }

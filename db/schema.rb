...
ActiveRecord::Schema[7.0].define(version: 2023_07_31_101342) do
  ...
  create_table "expenses", force: :cascade do |t|
    ...
    t.integer "expense_status", default: 0, null: false
    t.index ["expense_report_id"], name: "index_expenses_on_expense_report_id"
    t.index ["invoice_number"], name: "index_expenses_on_invoice_number", unique: true
